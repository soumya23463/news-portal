                ...
                ?>
                  ...
                  <form  action="save-settings.php" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <input type="text" name="website_name" value="<?= $row['websitename']; ?>" class="form-control" autocomplete="off" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <textarea name="footer_desc" class="form-control" rows="5" required><?= $row['footerdesc']; ?></textarea>
                      </div>
